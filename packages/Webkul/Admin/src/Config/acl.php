...
return [
    [
        ...
        'name' => 'Add Testimaonial',
        'route' => 'admin.add-testimonial',
        'sort' => 1
    ],[
        'key' => 'testimonials.edit-testimonial',
        'name' => 'Edit Testimonial',
        'route' => 'admin.edit-testimonial',
        'sort' => 2
    ],[
        'key' => 'testimonials.delete-testimonial',
        'name' => 'Delete Testimonial',
        'route' => 'admin.delete-testimonial',
        'sort' => 3
    ],
];
