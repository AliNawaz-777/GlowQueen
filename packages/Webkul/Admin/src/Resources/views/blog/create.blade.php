                    ...
                    <accordian :title="'{{ __('admin::app.catalog.attributes.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('url_key') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="url_key" name="url_key" value=""  data-vv-as="&quot;{{ __('admin::app.blog.blog-slug') }}&quot;" v-code/>
                            ...
                            <div class="control-group" :class="[errors.has('tags-1') ? 'has-error' : '']">
                                ...
                                <input id="form-tags-1" v-validate="'required'" class="control" name="tags-1" type="text" value="" data-vv-as="&quot;{{ __('admin::app.blog.blog-tags') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('blog-date') ? 'has-error' : '']">
                                ...
                                <input type="text" id="datepicker" class="control" name="blog-date" value="" v-validate="'required'" data-vv-as="&quot;Blog Date&quot;">
                    ...
                    <accordian :title="'{{ __('admin::app.blog.description-title') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('blog_short_description') ? 'has-error' : '']">
                                ...
                                <textarea v-validate="'required'" class="control" id="blog_short_description" name="blog_short_description" data-vv-as="&quot;Short Description&quot;"></textarea>
                            ...
                            <div class="control-group" :class="[errors.has('blog_description') ? 'has-error' : '']">
                                ...
                                <textarea v-validate="'required'" class="control" id="blog_description" name="blog_description" data-vv-as="&quot;{{ __('admin::app.blog.description-title') }}&quot;"></textarea>
                    ...
                    <accordian :title="'Meta Description'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('meta_title') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="meta_title" name="meta_title" value=""  data-vv-as="&quot;Meta Title&quot;"/>
                            ...
                            <div class="control-group" :class="[errors.has('meta_description') ? 'has-error' : '']">
                                ...
                                <textarea v-validate="'required'" class="control" id="meta_description" name="meta_description" data-vv-as="&quot;Meta Description&quot;"></textarea>
                            ...
                            <div class="control-group" :class="[errors.has('meta_keyword') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="meta_keyword" name="meta_keyword" value=""  data-vv-as="&quot;Meta Keyword&quot;"/>
