...
@section('content-wrapper')
    ...
    <div class="content full-page">
        <div class="page-header">
            ...
            <button type="button" class="btn btn-lg btn-primary" tracking-id="{{$shipment->track_number}}" id="track-order-call-courier">
                    Track Order
                </button>
                <a type="button" target="_blank" href="http://cod.callcourier.com.pk/Booking/AfterSavePublic/{{ $shipment->track_number }}" class="btn btn-lg btn-primary">
                    Call Courier Slip
                </a>
            </div>
        </div>
