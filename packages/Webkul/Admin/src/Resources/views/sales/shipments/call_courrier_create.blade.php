...
@section('content-wrapper')
    <div class="content full-page">
        <form method="POST" action="{{ route('admin.sales.shipments.callourier.store', $order->id) }}" @submit.prevent="onSubmit">
            @csrf()
            ...
            <div class="page-content">
                <div class="sale-container">
                    ...
                    <accordixan :title="'{{ __('admin::app.sales.orders.payment-and-shipping') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="sale-section">
                                ...
                                <div class="section-content">
                                    ...
                                    <div class="control-group" :class="[errors.has('shipment[description]') ? 'has-error' : '']" style="margin-top: 40px">
                                        <label for="shipment[description]" class="required">Description</label>
                                        <input type="text" v-validate="'required'" class="control" id="shipment[description]" name="shipment[description]" data-vv-as="&quot; Description &quot;"/>
                                        <span class="control-error" v-if="errors.has('shipment[description]')">
                                            @{{ errors.first('shipment[description]') }}
                                        </span>
                                    </div>
