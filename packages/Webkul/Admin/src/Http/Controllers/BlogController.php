...
class BlogController extends Controller
{
    ...
    */
    ...
    public function edit($id)
    {
        ...
        foreach ($blog_images as $img) {
            $blog_images[$i]['url'] = URL("/storage/".$img['path']);
            $images[$i] = $img['path'];
            $i++;
        }
        ...
        return view($this->_config['view'], compact('blogs', 'images', 'comments', 'categories'));
    }
    ...
    public function update(){
        ...
        $blog = $this->blogRepository->update($new_blog, $id);
