    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            Route::prefix('sales')->group(function () {
                ...
                //For Call courier
                Route::get('/shipments/call-courrier/{order_id}', 'Webkul\Admin\Http\Controllers\Sales\ShipmentController@CallCourrier') ->defaults('_config', ['view' => 'admin::sales.shipments.call_courrier_create'])
                ->name('admin.sales.shipments.order.callcourrier');
                ...
                // For order On Call Courier
                Route::post('/shipments/call-courier/{order_id}', 'Webkul\Admin\Http\Controllers\Sales\ShipmentController@orderNowCallCourier')->defaults('_config', [
                    'redirect' => 'admin.sales.orders.view'
                ])->name('admin.sales.shipments.callourier.store');
            ...
            // Call Courier API seting 
            Route::get('/call-courier-setting', 'Webkul\Core\Http\Controllers\CallCourierSettingController@index')->defaults('_config', [
                'view' => 'admin::settings.call_courier_seting.edit'
            ])->name('admin.call-courier-setting.index');

            Route::post('/call-courier-setting/update', 'Webkul\Core\Http\Controllers\CallCourierSettingController@store_update')->defaults('_config', [
                'redirect' => 'admin.call-courier-setting.index'
            ])->name('admin.call-courier-setting.update');

            Route::get('/call-courier-setting/get-areas', 'Webkul\Core\Http\Controllers\CallCourierSettingController@getAreasByCity')->name('admin.call-courier-setting.get-areas');

            Route::get('/call-courier-setting/track-history', 'Webkul\Core\Http\Controllers\CallCourierSettingController@trackHistory')->name('admin.call-courier-setting.track-history');
            ...
            {
                Route::get('/', 'Webkul\Admin\Http\Controllers\BlogController@index')->defaults('_config', [
                    'view' => 'admin::blog.index'
                ])->name('admin.blog');

                Route::get('/create-blog', 'Webkul\Admin\Http\Controllers\BlogController@create')->defaults('_config', [
                    'view' => 'admin::blog.create'
                ])->name('admin.blog.create');
                Route::post('/store-blog', 'Webkul\Admin\Http\Controllers\BlogController@store')->defaults('_config', [
                    'view' => 'admin::blog.index'
                ])->name('admin.blog.store');
                Route::post('/update', 'Webkul\Admin\Http\Controllers\BlogController@update')->defaults('_config', [
                    'view' => 'admin::blog.index'
                ])->name('admin.blog.update');
                Route::get('/view/{id}', 'Webkul\Admin\Http\Controllers\BlogController@view')->defaults('_config', [
                    'view' => 'admin::blog.view'
                ])->name('admin.blog.view');
                Route::get('/view/cancel/{id}', 'Webkul\Admin\Http\Controllers\BlogController@cancelBlog')->defaults('_config', [
                    'view' => 'admin::blog.view'
                ])->name('admin.blog.cancel');
                Route::get('/view/confirm/{id}', 'Webkul\Admin\Http\Controllers\BlogController@confirmBlog')->defaults('_config', [
                    'view' => 'admin::blog.view'
                ])->name('admin.blog.confirm');
                Route::get('/view/delete/{id}', 'Webkul\Admin\Http\Controllers\BlogController@blogDelete')->defaults('_config', [
                    'view' => 'admin::blog.view'
                ])->name('admin.blog.delete');
                Route::get('/view/edit/{id}', 'Webkul\Admin\Http\Controllers\BlogController@edit')->defaults('_config', [
                    'view' => 'admin::blog.edit'
                ])->name('admin.blog.edit');
                Route::get('/view/comment/{id}', 'Webkul\Admin\Http\Controllers\BlogController@deleteComment')->defaults('_config', [
                    'view' => 'admin::blog.view'
                ])->name('admin.blog.comment.delete');
                Route::post('/change/comment/status','Webkul\Admin\Http\Controllers\BlogController@changeComment');
            });
              // testimonail route

             Route::prefix('testimonail')->group(function ()
            {
            Route::get('/', 'Webkul\Admin\Http\Controllers\TestimonailController@index')->defaults('_config', [
                    'view' => 'admin::testimonail.index'
                ])->name('admin.testimonails');

             Route::get('/create-testimonail', 'Webkul\Admin\Http\Controllers\TestimonailController@create')->defaults('_config', [
                    'view' => 'admin::testimonail.create'
                ])->name('admin.testimonail.create');
             Route::post('/store-testimonail', 'Webkul\Admin\Http\Controllers\TestimonailController@store')->defaults('_config', [
                    'view' => 'admin::testimonail.index'
                ])->name('admin.testimonail.store');
             Route::get('/view/{id}', 'Webkul\Admin\Http\Controllers\TestimonailController@view')->defaults('_config', [
                    'view' => 'admin::testimonail.view'
                ])->name('admin.testimonail.view');
             Route::get('/view/delete/{id}', 'Webkul\Admin\Http\Controllers\TestimonailController@blogDelete')->defaults('_config', [
                    'view' => 'admin::testimonail.view'
                ])->name('admin.testimonail.delete');
