 ...
 *
 * @author  Arhamsoft <info@arhamsoft.com> @jitendra-webkul
...
class OnepageController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        // $this->nonCoupon->apply();
        // Cart::collectTotals();
        // $shippingRateGroups = Shipping::collectRates();

        //return view($this->_config['view'], compact('cart','shippingRateGroups'));
    ...
    */
     ...
     * @return \Illuminate\Http\Response
    */
    public function getShippingPage()
    {
        $cart = Cart::getCart();
