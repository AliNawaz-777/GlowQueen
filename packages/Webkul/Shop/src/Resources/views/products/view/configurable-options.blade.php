            ...
            Vue.component('product-options', {
                ...
                methods: {
                    ...
                    reloadPrice: function () {
                        ...
                        var priceLabelElement = document.querySelector('.prod-price-org');
                        var priceElement = document.querySelector('.prod-price-new');
                        ...
                        if (this.childAttributes.length == selectedOptionCount) 
                        {
                            ...
                            var priceWithSymbal = this.config.variant_prices[this.simpleProduct].final_price.formated_price;
                            var strArray = priceWithSymbal.split(" ");
                            priceElement.innerHTML = '<sup style="color:#ff9f15">'+strArray[0]+'</sup> '+Math.round(strArray[1]);

                            eventBus.$emit('configurable-variant-selected-event', this.simpleProduct)
                        } 
                        else 
                        {
                            priceLabelElement.style.display = 'block';
