    ...
    <div style="padding: 30px;">
        ...
        <div style="display: flex;flex-direction: row;margin-top: 20px;justify-content: space-between;margin-bottom: 40px;">
            <div style="line-height: 25px;">
                ...
                <div>
                    {{ $order->shipping_address->address1 }}, {{ $order->shipping_address->city }}, {{ $order->shipping_address->postcode }} {{ $order->shipping_address->state }}
                </div>
            ...
            <div style="line-height: 25px;">
                ...
                <div>
                    {{ $order->billing_address->address1 }}, {{ $order->billing_address->city }}, {{ $order->billing_address->postcode }} {{ $order->billing_address->state }}
                </div>
