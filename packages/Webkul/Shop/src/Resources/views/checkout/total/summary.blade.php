                ...
                <div class="discount">
                    ...
                    <div class="discount-group">
                        ...
                        <form class="coupon-form" method="post" @submit.prevent="onSubmit">
                            ...
                            <div class="control-group mt-20 mx-0 w-100" :class="[errors.has('code') ? 'has-error' : '']" style="margin-bottom: 10px">
                            ...
                            <button class="btn btn-lg btn-primary btn-black" :disabled="couponChanged">{{ __('shop::app.checkout.onepage.apply-coupon') }}</button>
