<form data-vv-scope="address-form">
            ...
            <div class="address-card" v-for='(addresses, index) in this.allAddress'>
                <div class="checkout-address-content" style="display: flex; flex-direction: row; justify-content: space-between; width: 100%;">
                    <label class="radio-container" style="float: right; width: 10%;">
                        <input type="radio" id="billing[address_id]" name="billing[address_id]" :id="addresses.id" name="selectedAddress"  :value="addresses.id" v-model="address.billing.address_id" >
                    ...
                    <ul class="address-card-list" style="float: right; width: 85%;">
                        ...
                        <li v-if="addresses.city" class="mb-5">
                            @{{ addresses.city }} <span v-if="addresses.postcode"> - @{{ addresses.postcode }}</span>,
                        </li>

                        <li v-if="addresses.state" class="mb-5">
                            @{{ addresses.state }},
                        </li>
    ...
    <div class="billing-form-field">
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[city]') ? 'has-error' : '']">
            ...
            <select type="text" v-validate="'required'" class="control" id="billing[city]" name="billing[city]" v-model="address.billing.city" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.city') }}&quot;">
                @foreach ( DB::table('call_courier_cities')->get() as $city )
                    <option value="{{ ucfirst(strtolower($city->city_name)) }}">{{ ucfirst(strtolower($city->city_name)) }}</option>
                @endforeach
            </select>
    ...
    <div class="billing-form-field">
        <div class="control-group" :class="[errors.has('address-form.billing[state]') ? 'has-error' : '']">
            ...
            <input type="text" class="control" id="billing[state]" name="billing[state]" v-model="address.billing.state" v-if="!haveStates('billing')" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.state') }}&quot;"/>

            <select class="control" id="billing[state]" name="billing[state]" v-model="address.billing.state" v-if="haveStates('billing')" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.state') }}&quot;">
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[postcode]') ? 'has-error' : '']">
            ...
            <input type="text" class="control" id="billing[postcode]" name="billing[postcode]" v-model="address.billing.postcode" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.postcode') }}&quot;"/>
    ...
    <div class="billing-form-field">
        <div class="control-group" :class="[errors.has('address-form.billing[country]') ? 'has-error' : '']">
            ...
            <select type="text" v-validate="'required'" class="control custom-readonly-select" id="billing[country]" name="billing[country]" v-model="address.billing.country" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.country') }}&quot;">
                <option value=""></option>
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[phone]') ? 'has-error' : '']">
            <label for="billing[phone]" class="required">
                {{ __('shop::app.checkout.onepage.phone') .' (03001234567)' }}
            </label>

            <input type="tel" maxlength="11" v-validate="'required'" class="control input_billing" id="billing[phone]" @keypress="onlyNumber" @change="checkPhoneNumber('billing')" name="billing[phone]" v-model="address.billing.phone" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.phone') }}&quot;"/>
        ...
        <div class="form-container" v-if="!address.billing.use_for_shipping && this.new_shipping_address">
            ...
            <div class="billing-form-field">
                ...
                <div class="control-group" :class="[errors.has('address-form.shipping[city]') ? 'has-error' : '']">
                    ...
                    <select type="text" v-validate="'required'" class="control" id="shipping[city]" name="shipping[city]" v-model="address.shipping.city" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.city') }}&quot;">
                        @foreach ( DB::table('call_courier_cities')->get() as $city )
                            <option value="{{ ucfirst(strtolower($city->city_name)) }}">{{ ucfirst(strtolower($city->city_name)) }}</option>
                        @endforeach
                    </select>
            ...
            <div class="billing-form-field">
                <div class="control-group" :class="[errors.has('address-form.shipping[state]') ? 'has-error' : '']">
                    ...
                    <input type="text" class="control" id="shipping[state]" name="shipping[state]" v-model="address.shipping.state" v-if="!haveStates('shipping')" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.state') }}&quot;"/>

                    <select class="control" id="shipping[state]" name="shipping[state]" v-model="address.shipping.state" v-if="haveStates('shipping')" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.state') }}&quot;">
                ...
                <div class="control-group" :class="[errors.has('address-form.shipping[postcode]') ? 'has-error' : '']">
                    ...
                    <input type="text" class="control" id="shipping[postcode]" name="shipping[postcode]" v-model="address.shipping.postcode" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.postcode') }}&quot;"/>
            ...
            <div class="billing-form-field">
                <div class="control-group" :class="[errors.has('address-form.shipping[country]') ? 'has-error' : '']">
                    ...
                    <select type="text" v-validate="'required'" class="control custom-readonly-select" id="shipping[country]" name="shipping[country]" v-model="address.shipping.country" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.country') }}&quot;">
                        <option value=""></option>
                ...
                <div class="control-group" :class="[errors.has('address-form.shipping[phone]') ? 'has-error' : '']">
                    ...
                    <input type="tel" maxlength="11" v-validate="'required'" class="control input_shipping" id="shipping[phone]" name="shipping[phone]" v-model="address.shipping.phone" @change="checkPhoneNumber('shipping')" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.phone') }}&quot;"/>
