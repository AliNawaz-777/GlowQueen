...
@section('page_title')
    ...
    Customer Registration | Best Online Jewelry Store - UClick.PK

@endsection

@section('content-wrapper')

<div class="container login-form-des signup-form-des">
    <div class="row">
        <div class="col-lg-6 col-md-12 padd-r">
        ...
        <div class="col-lg-6 col-md-12 padd-l">
            <div class="auth-content login-right-wrapper">
