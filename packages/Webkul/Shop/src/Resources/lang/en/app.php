...
return [
    'wishlist' => [
        'success-cart' => 'Item moved to cart successfully'
    ],
    ...
    'products' => [
        ...
        'buy-now' => 'Buy Now',
        'whoops' => 'No product is available!',
        'quantity' => 'Quantity',
        'in-stock' => 'In Stock',
    ...
    'checkout' => [
        'cart' => [
            'integrity' => [
                ...
                'missing_options' => 'Please select options before buying this product.',
            ...
            'quantity' => [
                ...
                'inventory_warning' => 'The requested quantity is not available. It will be restocked soon!.',
                'error' => 'Cannot update the item(s) at the moment, please try again later.'
            ],

            'item' => [
                'error_remove' => 'No items to remove from the cart.',
                'success' => 'Item is successfully added to cart. CHEERS! You Have Won A Free Gift.',
                'success_single' => 'Item is successfully added to cart.',
                'success_multiple' => 'Items are successfully added to cart.',
        ...
        'success' => [
            ...
            'thanks' => 'Thank you for Choosing GlowQueen',
            'order-id-info' => 'Your order id is #:order_id',
            'info' => 'You will receive your order details and tracking information via email'
        ]
    ],
    ...
    'mail' => [
        'order' => [
            ...
            'thanks' => 'Thank you for Choosing GlowQueen!',
            'msg'=>'You will receive your order details and tracking information via email',
        ...
        'customer' => [
            ...
            'registration' => [
                'subject' => 'New Customer Registration',
                'customer-registration' => 'Your GlowQueen Account is Ready!',
                'dear' => 'Dear :customer_name',
                'greeting' => 'Welcome to GlowQueen, the best online store.',
                'contact' => 'Welcome and thank you for contacting with us!',
                 'msg'=> 'we will get back to you shortly',
                'summary' => 'This is your confirmation email for signing up with us. After login, setup your account details and start placing your order(s) online. We’re here to help you get the most from our online store. Contact us at glowqueen@glowqueen.pk 
',
                'thanks' => 'Thanks!',
                'regards'=>'Kind Regards,',
                'team'=>'Team GlowQueen'
